...
class NewTicketsListWidget extends StatefulWidget {
  ...
  @override
  State<NewTicketsListWidget> createState() => _NewTicketsListWidgetState();
}

class _NewTicketsListWidgetState extends State<NewTicketsListWidget> {
  @override
  void initState() {
    super.initState();
    context.read<MyTicketsCubit>().fetchMyTickets(1);
  }
